 ...
 * @author Gaurav Walia
 **/
export const checkBackground = (background)=>{
 ...
 * @author Gaurav Walia
 **/
export const getColorIdFromMap = (key)=>{
 ...
 * @author Gaurav Walia
 **/
export const getAvailableCode = (value)=>{
    if (value === null || value === '') {
        return null;
    }
    let result = '';
 ...
 * @author Gaurav Walia
 **/
export const getBackgroundCode = (background)=>{
 ...
 * @author Gaurav Walia
 **/
export const getFormatColorCode = (format, color)=>{
 ...
 * @author Gaurav Walia
 **/
export const getFormatBgCode = (format, background)=>{
    let isFormatAdded = false;
    let isBgAdded = false;
    let result = START_STRING;
    if (checkFormat(format)) {
 ...
 * @author Gaurav Walia
 **/
export const getColorBgCode = (color, background) => {
    let isColorAdded = false;
    let isBgAdded = false;
    let result = START_STRING;
    if (checkColor(color)) {
 ...
 * @author Gaurav Walia
 **/
export const getRainbowCode = (format, color, background)=>{
    let isFormatAdded = false;
    let isColorAdded = false;
    let isBgAdded = false;
    let result = START_STRING;
 ...
 * @author Gaurav Walia
 **/
export const getRainbowStringFromObject = (obj)=>{
 ...
 * @author Gaurav Walia
 **/
export const getFormatString = (format, str, end)=>{
 ...
 * @author Gaurav Walia
 **/
export const getColorString = (color, str, end)=>{
 ...
 * @author Gaurav Walia
 **/
export const getBgString = (background, str, end) => {
 ...
 * @author Gaurav Walia
 **/
export const getFormatColorString = (format, color, str, end)=>{
 ...
 * @author Gaurav Walia
 **/
export const getFormatBgString = (format, background, str, end) => {
 ...
 * @author Gaurav Walia
 **/
export const getColorBgString = (color, background, str, end)=>{
 ...
 * @author Gaurav Walia
 **/
export const getRainbowString = (format, color, background, str, end)=>{
